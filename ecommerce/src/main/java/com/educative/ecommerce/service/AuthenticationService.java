...
public class AuthenticationService{
    ...
    public AuthenticationToken getToken(User user) { return tokenRepository.findByUser(user);}
    ...
    public void authenticate(String token)throws AuthenticationFailException{
        ...
        if(Objects.isNull(getUser(token))) { throw new AuthenticationFailException("token not valid"); }
